...
MyMenu.Add("MS Publisher", (*) => Run("MSPUB.ExStyle"))
MyMenu.Add("MS Access", (*) => Run("MSACCESS.EXE"))
MyMenu.Add("MS PowerPoint", (*) => Run("POWERPNT.EXE"))
MyMenu.Add("Notepad", (*) => Run("notepad.exe"))
MyMenu.Add("MS Visual Studio 22 Community", (*) => Run("C:\Program Files\Microsoft Visual Studio\2022\Community\Common7\IDE\devenv.exe"))
MyMenu.Add("VS Code", (*) => Run("C:\Program Files\Microsoft VS Code\Code.exe"))
...
MyMenu.Add("Chirp", (*) => Run("C:\Program Files (x86)\CHIRP\chirpwx.exe"))
MyMenu.Add("RT Systems", (*) => Run("D:\Radio\RT Systems V5\Explorer\QRZ1_V5\RadioEngine_V5.exe"))
MyMenu.Show()
}
...
; Obsidian
^!o:: { ;control + alt + n
	Run "C:\Users\sgarr\AppData\Local\Programs\Obsidian\Obsidian.exe"			
}	
